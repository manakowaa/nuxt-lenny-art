<template>
  ...
  >
    <g class="event-scene__dance-floor">
      <path
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[2],
        'event-scene__table--red': checks[2].red,
        'event-scene__table--disabled': checks[2].disabled,
      }"
      data-check="table_2"
      @click="onClick(2)"
    >
      <g class="event-scene__table-group" stroke="#1F1E1E">
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[3],
        'event-scene__table--red': checks[3].red,
        'event-scene__table--disabled': checks[3].disabled,
      }"
      data-check="table_3"
      @click="onClick(3)"
    >
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[4],
        'event-scene__table--red': checks[4].red,
        'event-scene__table--disabled': checks[4].disabled,
      }"
      data-check="table_4"
      @click="onClick(4)"
    >
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[5],
        'event-scene__table--red': checks[5].red,
        'event-scene__table--disabled': checks[5].disabled,
      }"
      data-check="table_5"
      @click="onClick(5)"
    >
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[6],
        'event-scene__table--red': checks[6].red,
        'event-scene__table--disabled': checks[6].disabled,
      }"
      data-check="table_6"
      @click="onClick(6)"
    >
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[7],
        'event-scene__table--red': checks[7].red,
        'event-scene__table--disabled': checks[7].disabled,
      }"
      data-check="table_7"
      @click="onClick(7)"
    >
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[8],
        'event-scene__table--red': checks[8].red,
        'event-scene__table--disabled': checks[8].disabled,
      }"
      data-check="table_8"
      @click="onClick(8)"
    >
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[9],
        'event-scene__table--red': checks[9].red,
        'event-scene__table--disabled': checks[9].disabled,
      }"
      data-check="table_9"
      @click="onClick(9)"
    >
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[10],
        'event-scene__table--red': checks[10].red,
        'event-scene__table--disabled': checks[10].disabled,
      }"
      data-check="table_10"
      @click="onClick(10)"
    >
    ...
    <g
      class="event-scene__table"
      :class="{
        'event-scene__table--active': checked[11],
        'event-scene__table--red': checks[11].red,
        'event-scene__table--disabled': checks[11].disabled,
      }"
      data-check="table_11"
      @click="onClick(11)"
    >
      ...
      <path
        class="event-scene__table-num"
        d="M45.1992 241H41.2832V233.441C41.2832
        232.523 41.3027 231.684 41.3418 230.922C41.1009 231.215 40.8014 231.521
        40.4434 231.84L38.8223 233.178L36.8203 230.717L41.7227
        226.723H45.1992V241ZM56.918 241H53.002V233.441C53.002 232.523 53.0215
        231.684 53.0605 230.922C52.8197 231.215 52.5202 231.521 52.1621
        231.84L50.541 233.178L48.5391 230.717L53.4414 226.723H56.918V241Z"
        fill="#1F1E1E"
      />
...
const checked = computed(() => {
  ...
  if (Array.isArray(props.values.table)) {
    props.values.table.forEach((table) => {
      checked[table] = true;
    });
  }
...
.event-scene {
  &__table {
    cursor: pointer;
    &--active {
      .event-scene__table-group {
        fill: @black;
      }
      .event-scene__table-num {
        fill: @white;
      }
      &.event-scene__table--red {
        .event-scene__table-group {
          fill: @red;
        }
      }
